...
@Configuration
@ComponentScan({ "com.david.basilio" })
    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.david.basilio");
                servletContext.setInitParameter("tapestry.development-modules", "com.david.basilio.services.DevelopmentModule");
